...
public final class Launcher extends Activity
    ...
    private static final String TOOLBAR_ICON_METADATA_NAME = "com.android.launcher2.toolbar_icon";
    ...
    */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!getResources().getBoolean(R.bool.config_superosr)) {
...
//        }
    ...
    private void updateAppMarketIcon() {
        ...
        if (activityName != null && (ViewConfiguration.get(this).hasPermanentMenuKey() ||
                getResources().getBoolean(R.bool.config_superosr))) {
            int coi = getCurrentOrientationIndexForGlobalIcons();
